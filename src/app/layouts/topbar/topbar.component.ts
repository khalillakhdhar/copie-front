...
export class TopbarComponent implements OnInit {
  ...
  listLang: any = [
    { text: 'French', flag: 'assets/images/flags/tunisia.jpg', lang: 'en' },
  ...
  ngOnInit() {
    ...
    if (val.length === 0) {
      if (this.flagvalue === undefined) { this.valueset = 'assets/images/flags/tunisia.jpg'; }
    } else {
  ...
  navigateToSettings() {
    this.router.navigate(['/layouts/rightsidebar']);
  }
}